    ...
    try {
      ...
      if (body.booking_id) {
        ...
        if (booking) {
          ...
          await sendCriticalAlert("schedule-balance-payment", booking.reservation_number || body.booking_id, errorMessage, body.booking_id);
          await logCriticalError(supabase, body.booking_id, "schedule-balance-payment", err);
        }
      }
    } catch (alertErr) {
