...
function generateBarVendorEmailHTML(data: StaffAssignmentEmailData): string {
  ...
  const clientEmailLine = data.clientEmail
    ? `<a href="mailto:${data.clientEmail}" style="color:#0f172a;text-decoration:underline;">${data.clientEmail}</a>`
    : "—";
  const clientPhoneLine = data.clientPhone
    ? `<a href="tel:${data.clientPhone}" style="color:#0f172a;text-decoration:underline;">${data.clientPhone}</a>`
    : "—";
        ...
        <table role="presentation" class="container" width="600" cellspacing="0" cellpadding="0" style="width:600px;max-width:600px;background:#ffffff;border-radius:14px;overflow:hidden;border:1px solid #e5e7eb;">
          ...
          <tr>
            <td class="px" style="padding:18px 24px 8px 24px;">
              <span style="display:inline-block;background:#fef3c7;color:#92400e;border:1px solid #fcd34d;border-radius:999px;padding:6px 10px;font-size:12px;font-weight:800;letter-spacing:.3px;">
                NEW BAR SERVICE ASSIGNMENT
              </span>
            </td>
          </tr>
          ...
          <tr>
            <td class="px" style="padding:10px 24px 8px 24px;">
              <div style="font-size:20px;line-height:28px;font-weight:800;color:#0f172a;">
                Hi ${firstName}, you have a new Bar Service assignment
              </div>
              <div style="margin-top:8px;font-size:14px;line-height:22px;color:#475569;">
                You have been assigned to a Bar Service booking at Orlando Event Venue. Please review the details below and contact the client directly.
              </div>
            </td>
          </tr>
          ...
          <!-- Bar service -->
          <tr>
            <td class="px" style="padding:8px 24px;">
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;">
                <tr>
                  <td style="padding:12px 14px;background:#fef3c7;font-weight:800;font-size:13px;color:#92400e;">
                    Bar Service
                  </td>
                </tr>
                <tr>
          ...
          <tr>
            <td class="px" style="padding:8px 24px;">
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;">
                <tr>
                  <td style="padding:12px 14px;background:#ecfeff;font-weight:800;font-size:13px;color:#155e75;">
                    Client Contact
                  </td>
                </tr>
                <tr>
                  <td style="padding:12px 14px;font-size:14px;line-height:22px;color:#334155;">
                    ...
                    <div><b>Email:</b> ${clientEmailLine}</div>
                    <div><b>Phone:</b> ${clientPhoneLine}</div>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <!-- Next steps -->
          <tr>
            <td class="px" style="padding:12px 24px 4px 24px;font-size:14px;line-height:22px;color:#334155;">
              Please log in to your Staff Dashboard, review the booking details, contact the client directly to confirm bar service details, and mark "Customer Contacted" once complete.
            </td>
          </tr>

          <!-- CTA -->
          <tr>
            <td class="px" style="padding:14px 24px 18px 24px;text-align:center;">
              <a href="${dashboardLink}" class="btn" style="display:inline-block;background:#92400e;color:#ffffff;text-decoration:none;padding:14px 22px;border-radius:12px;font-weight:800;font-size:14px;">
                Open Staff Dashboard
              </a>
              <div style="margin-top:10px;font-size:12px;color:#64748b;">
                If the button doesn't work, copy and paste this link:<br/>
                <span style="color:#0f172a;word-break:break-all;">${dashboardLink}</span>
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td class="px" style="padding:16px 24px;background:#0b1220;color:#cbd5e1;font-size:11px;line-height:16px;">
              <div><strong style="color:#ffffff;">Orlando Event Venue</strong></div>
              <div>3847 E Colonial Dr, Orlando, FL 32803</div>
              <div>orlandoeventvenue@gmail.com | (407) 974-5979</div>
              <div style="margin-top:6px;">orlandoeventvenue.org</div>
            </td>
          </tr>
        </table>
      </td>
