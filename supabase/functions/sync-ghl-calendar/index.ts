...
function buildEventNotes(booking: BookingData, staffInfo: StaffInfo[]): string {
  const notesLines = [
    `Orlando Event Venue: Access Reminder & Rules (Guest Reference)`,
    ``,
    `Welcome to Orlando Event Venue`,
    ``,
    `📍 3847 E Colonial Dr, Orlando, FL 32803`,
    ``,
    `Access Instructions: Please refer to the automated access email(s) you received from us. Those emails contain the exact steps and codes needed to enter the venue. (Check your inbox + spam/junk.)`,
    ``,
    `Wi-Fi: TMOBILE-9371`,
    `Password: 7km6r7y5ybn`,
    ``,
    `━━━━━━━━━━━━━━━━━━━━━━━━━━`,
    `Venue Rules & Fees (Important)`,
    `━━━━━━━━━━━━━━━━━━━━━━━━━━`,
    ``,
    `Setup & Breakdown: $150 fee`,
    `Guests must return chairs/tables to their original layout within the allocated setup/breakdown time.`,
    ``,
    `No Alcohol: $250 fee`,
    `Strictly prohibited. Violations may be verified by cameras. Severe cases may end the event without refund.`,
    ``,
    `No Drugs: $500 fee`,
    `Strictly prohibited. Law enforcement may be notified.`,
    ``,
    `No Smoking: $300 fee`,
    `No smoking indoors or around the venue perimeter.`,
    ``,
    `No Pets: $100 fee`,
    `Only certified service animals allowed with prior authorization.`,
    ``,
    `Food & Beverage: $300 fee for violations`,
    `Professional caterers allowed (liability insurance required).`,
    `Commercially prepared food is permitted.`,
    `No on-site cooking unless pre-approved.`,
    ``,
    `No Glitter / Confetti / Rice: $300 cleaning fee`,
    `Strictly prohibited.`,
    ``,
    `Time Limits: $200 per hour`,
    `Setup/breakdown time is included in your booking. Overtime is billed if you exceed your scheduled end time.`,
    ``,
    `Noise Limits: $150 fee`,
    `Amplified music must stay within city ordinance limits. Events must end before quiet hours.`,
    ``,
    `Occupancy Limit: $200 fee`,
    `Maximum capacity is 90 guests.`,
    ``,
    `Decorations: $200 fee for damage`,
