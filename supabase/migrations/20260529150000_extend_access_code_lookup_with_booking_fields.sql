-- Extend get_access_code_for_reservation to return booking fields needed by
-- the unified /accesscode page (gate code BEFORE end_time, guest report AFTER).
